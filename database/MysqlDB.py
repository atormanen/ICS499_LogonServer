...
class MysqlDB:
    ...
    def saveAccountInfo(self, username, data):
        querry = "UPDATE user SET user.avatar = " + str(data["avatarStyle"]) + ", user.chess_board_style = " + str(data["chessboardStyle"]) + ", user.chess_piece_style = " + str(data["chesspieceStyle"]) +\
